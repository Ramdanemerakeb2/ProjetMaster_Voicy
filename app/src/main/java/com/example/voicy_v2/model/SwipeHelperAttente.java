...
public class SwipeHelperAttente extends ItemTouchHelper.Callback
{
    // Attribute
    ...
    private RecyclerAttenteAdapter adapter;

    public SwipeHelperAttente(Context theContext, RecyclerAttenteAdapter theAdapter)
    {
        context = theContext;
        adapter = theAdapter;
